...
const sections = [
  ...
  },
  {
    title: '三、存储与安全',
    lines: [
      '1. 数据存储于 Supabase 提供的云端数据库与对象存储服务。',
      '2. 数据按家庭做行级权限隔离：每个账号只能访问自己所属家庭的数据，其它账号即使知道数据编号也无法读取。',
      '3. 照片存放于私有存储桶，访问需要经过鉴权的临时链接，不做公开暴露。',
      '4. 我们只在服务端保管敏感密钥，前端代码中不包含任何可直接绕过权限的密钥。',
    ],
  },
  {
    title: '四、儿童个人信息保护',
